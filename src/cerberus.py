...
if __name__ == "__main__":
    train_file_path = r'.\legal_data\stage_3\s3_best_labels.csv' 

    train_no_facts = r'.\legal_data\no_facts\s2_and_s3_no_facts.csv'

    validate_file_path = r'.\legal_data\stage_4\team_1\s4_t1_best_labels.csv'

    #full_predictions = run_cerberus(train_file_path, train_no_facts, validate_file_path, k=4, num_epochs=10)
    evaluate_cerberus(train_file_path, train_no_facts, validate_file_path, k=8, num_epochs=10)
